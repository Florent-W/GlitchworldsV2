 ...
 */
final class Version20260814021549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(80) NOT NULL, slug VARCHAR(80) NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_835033F8989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE jeu_genre (jeu_id INT NOT NULL, genre_id INT NOT NULL, INDEX IDX_B1B530008C9E392E (jeu_id), INDEX IDX_B1B530004296D31F (genre_id), PRIMARY KEY (jeu_id, genre_id)) DEFAULT CHARACTER SET utf8mb4');
