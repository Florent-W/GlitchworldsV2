...
final class SignalementRepository extends ServiceEntityRepository
{
    ...
    public function trouverPourModeration(?StatutSignalement $statut = null, bool $liensUniquement = false): array
    {
        ...
        if ($liensUniquement) { $requete->andWhere('s.motif = :motifLien')->setParameter('motifLien', \App\Enum\MotifSignalement::LienManquant); }
