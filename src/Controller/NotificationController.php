...
final class NotificationController extends AbstractController
{
    ...
    #[Route('/panneau', name: 'app_notifications_panneau', methods: ['GET'])] public function panneau(NotificationRepository $repository): Response { $membre = $this->membre(); return $this->render('notification/_panneau.html.twig', ['notifications' => $repository->trouverPour($membre, 6), 'nonLues' => $repository->compterNonLues($membre)]); }
