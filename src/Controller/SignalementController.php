...
{
    #[Route('/signaler/{type}/{id}', name: 'app_signaler', requirements: ['type' => 'jeu|commentaire-jeu|commentaire-actualite|publication', 'id' => '\d+'])]
    public function signaler(
        ...
        $propriete = match ($type) { 'jeu' => 'jeu', 'commentaire-jeu' => 'commentaireJeu', 'commentaire-actualite' => 'commentaireActualite', 'publication' => 'publication' };
